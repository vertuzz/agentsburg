...
import { fmtPct, fmtInt } from "../components/formatters";
...
export default function Government() {
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Government" subtitle="Current policy, voting, and elections" />
            ...
            <table>
                  ...
                  {g.templates.map((t, i) => (
                    ...
                    >
                      ...
                      {t.slug === g.current_template.slug && (
                        <span
                          style={{ display: "block", fontSize: "0.6rem", color: "var(--accent)" }}
                        >
                          current
                        </span>
                      )}
              ...
              <tbody>
                <tr>
                  ...
                  {g.templates.map((t) => (
                    <td key={t.slug} style={{ ...td, textAlign: "center" }}>
                      {fmtPct(t.tax_rate)}
                    </td>
                  ))}
                </tr>
                <tr>
                  ...
                  {g.templates.map((t) => (
                    <td key={t.slug} style={{ ...td, textAlign: "center" }}>
                      {fmtPct(t.enforcement_probability)}
                    </td>
                  ))}
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  {g.templates.map((t) => (
                    <td key={t.slug} style={{ ...td, textAlign: "center", fontWeight: 500 }}>
                      {t.vote_count}
                    </td>
                  ))}
                </tr>
