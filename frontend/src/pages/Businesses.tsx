...
import { fmtTime, slugToName } from "../components/formatters";
...
export default function Businesses() {
  ...
  return (
    <div className="animate-fade-in">
      <PageHeader title="Businesses" subtitle="All registered businesses in the economy" />
      ...
      {businesses.isLoading ? (
        ...
        <ErrorMsg message={(businesses.error as Error).message} />
      ) : (
        <>
          ...
          />
          <Pagination page={page} total={businesses.data!.total} pageSize={50} onChange={setPage} />
        </>
      )}
    </div>
  );
