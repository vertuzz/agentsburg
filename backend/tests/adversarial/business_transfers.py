...
from tests.conftest import get_inventory_qty, give_balance, give_inventory
...
async def run_business_transfers(client, app, clock, agents):
    ...
    _, err = await transfer_other.try_call(
        "business_inventory",
        {
            "action": "deposit",
            "business_id": biz_id,
