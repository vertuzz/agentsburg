"""
Reference-data seeders: zones, goods, and recipes.

These functions upsert canonical reference data from YAML config files into the
database. They run during app lifespan (via bootstrap) and are idempotent — safe
